...
def create_url(start_year, end_year, page):
    ...
    url = "http://www.scorespro.com/rugby-union/ajaxdata.php?country=italy&comp=national-competition-excellence&league=&season=" + str(
...
def start_crawl(current_year, start_page):
...
#PARAMATERS TO SET
tournament_name = "eccellenza"
#SET TO CURRENT YEAR
current_year = datetime.datetime.now().year
start_page = 1

start_crawl(current_year, start_page)